    ...
    <div className="bg-brand-light min-h-screen">
      <div className="bg-brand-black text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">Soluciones Adicionales</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-20">
        ...
        {/* Bodega con Oficina */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-10 md:mb-16 flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/2 bg-gray-200 relative min-h-[200px] md:min-h-[300px]">
          ...
          <div className="w-full lg:w-1/2 p-6 md:p-10 lg:p-14 flex flex-col justify-center">
