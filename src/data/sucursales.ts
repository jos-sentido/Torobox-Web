...
export const SUCURSALES: Sucursal[] = [
  {
    ...
    bodegas: [
      ...
      { id: '7',    label: '7 m²',    area: 7,    precios: { baja: 3150, alta: 2940 }, descuentos: DESC_VTA },
      { id: '10',   label: '10 m²',   area: 10,   precios: { baja: 4500, alta: 4200 }, descuentos: DESC_VTA },
      { id: '15',   label: '15 m²',   area: 15,   precios: { baja: 6750, alta: 6300 }, descuentos: DESC_VTA },
      { id: '30',   label: '30 m²',   area: 30,   precios: { baja: 13500 }, descuentos: DESC_VTA },
  ...
  },
  {
    ...
    nombre: 'Punto Sur',
    bodegas: [
      { id: '3.5',  label: '3.5 m²',  area: 3.5,  precios: { baja: 1700, alta: 1505 }, descuentos: DESC_PS_SM },
      { id: '7',    label: '7 m²',    area: 7,    precios: { baja: 3150, alta: 2940 }, descuentos: DESC_PS },
      { id: '10',   label: '10 m²',   area: 10,   precios: { baja: 4500, alta: 4200 }, descuentos: DESC_PS },
      { id: '15',   label: '15 m²',   area: 15,   precios: { baja: 6750, alta: 6300 }, descuentos: DESC_PS },
      { id: '30',   label: '30 m²',   area: 30,   precios: { baja: 13500 }, descuentos: DESC_PS },
    ],
  },
  {
    id: 'bucerias',
